...
2. ~~**SIN-M2**~~ ✅ tipos atualizados à mão até a migration 0032 e `supabase as any` removido do webhook EfiBank (regenerar com `supabase gen types` continua desejável, precisa de token)
