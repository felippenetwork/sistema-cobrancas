...
/**
 * Seletor de mês compartilhado — Dashboard, Cobranças e Caixa.
 * Navega via `?mes=YYYY-MM` na rota corrente.
 */
export function MonthSelector({ mesParam, basePath }: { mesParam: string; basePath: string }) {
